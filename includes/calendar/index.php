...
<form name="form1" method="post" action="">
  ...
  <table border="0" cellspacing="0" cellpadding="2">
    <tr>
      ...
      <td valign="top"><?php
		  $myCalendar = new tc_calendar("date2", false, true);
		  ...
		  $myCalendar->setTimezone("Amsterdam"); //Asia/Tokyo, America/Montreal, Australia/Melbourne, America/New_York
	...
	function setCalendarValue1(){
		setValue('date2', '<?php echo(date("Y-m-d")); ?>');
	}
	//-->
	        </script>
          </p>
  ...
  //$myCalendar->autoSubmit(true, "form1");
  $myCalendar->setSpecificDate(array("2011-04-01", "2011-04-13", "2011-04-26"), 0, 'month');
  ...
  echo($cscript);
  ?>
  <input type="button" name="button" id="button" value="Check the value" onClick="javascript:alert(this.form.date1.value);">
  <ul>
    <li>Default date  to current server date (Auto unset if date is disabled)</li>
    <li>Set year navigate from 1960 to 2025 </li>
    <li>Allow date selectable from 01 January 2010 to 01 March 2025</li>
  ...
  <p><b>Code:</b></p>
  <pre>&lt;?php<br>	  $myCalendar = new tc_calendar(&quot;date1&quot;, true);<br>	  $myCalendar-&gt;setIcon(&quot;calendar/images/iconCalendar.gif&quot;);<br>	  $myCalendar-&gt;setDate(01, 03, 1960);<br>	  $myCalendar-&gt;setPath(&quot;calendar/&quot;);<br>	  $myCalendar-&gt;setYearInterval(1960, 2017);<br>	  $myCalendar-&gt;dateAllow('2010-01-01', '2025-03-01');<br>	  $myCalendar-&gt;setSpecificDate(array(&quot;2011-04-01&quot;, &quot;2011-04-13&quot;, &quot;2011-04-25&quot;), 0, 'month');<br>	  $myCalendar-&gt;setOnChange(&quot;myChanged('test')&quot;);<br>	  $myCalendar-&gt;writeScript();<br>	  ?&gt;
...
&lt;script language=&quot;javascript&quot;&gt;<br>&lt;!--<br>function myChanged(v){<br>	alert(&quot;Hello, value has been changed : &quot;+document.getElementById(&quot;date1&quot;).value+&quot;[&quot;+v+&quot;]&quot;);<br>}<br>//--&gt;<br>&lt;/script&gt;</pre>
  ...
  <ul>
    ...
    <li>Set year navigate from 2000 to 2017 </li>
    <li>Allow date selectable from 13 May 2008 to 01 March 2025</li>
    <li>Allow to navigate other dates from above </li>
  ...
  <p><b>Code:</b></p>
  <pre>&lt;?php<br>	  $myCalendar = new tc_calendar(&quot;date5&quot;, true, false);<br>	  $myCalendar-&gt;setIcon(&quot;calendar/images/iconCalendar.gif&quot;);<br>	  $myCalendar-&gt;setDate(date('d'), date('m'), date('Y'));<br>	  $myCalendar-&gt;setPath(&quot;calendar/&quot;);<br>	  $myCalendar-&gt;setYearInterval(2000, 2017);<br>	  $myCalendar-&gt;dateAllow('2008-05-13', '2025-03-01');<br>	  $myCalendar-&gt;setDateFormat('j F Y');<br>	  $myCalendar-&gt;setAlignment('left', 'bottom');<br>	  $myCalendar-&gt;setSpecificDate(array(&quot;2011-04-01&quot;, &quot;2011-04-04&quot;, &quot;2011-12-25&quot;), 0, 'year');<br>	  $myCalendar-&gt;setSpecificDate(array(&quot;2011-04-10&quot;, &quot;2011-04-14&quot;), 0, 'month');<br>	  $myCalendar-&gt;setSpecificDate(array(&quot;2011-06-01&quot;), 0, '');<br>	  $myCalendar-&gt;writeScript();<br>	  ?&gt;</pre>
  ...
  <p><b>Code:</b></p>
  <pre>&lt;?php					<br>      $date3_default = &quot;<?php echo($date1); ?>&quot;;<br>      $date4_default = &quot;<?php echo($date2); ?>&quot;;<br><br>	  $myCalendar = new tc_calendar(&quot;date3&quot;, true, false);<br>	  $myCalendar-&gt;setIcon(&quot;calendar/images/iconCalendar.gif&quot;);<br>	  $myCalendar-&gt;setDate(date('d', strtotime($date3_default))
...
<hr>
<h5 class="largetxt">Calendar Properties</h5>
...
<h5 class="largetxt">Calendar Functions</h5>
<p><b>Constructor</b></p>
...
<p><i>tc_calendar (string bindObjectName, boolean date_picker, bool show_input, string timezone)</i></p>
<blockquote>
  <p> 'date_picker' default value is false.<br>
    'show_input' default value is true <br>
  'timezone' default value is system timezone (as php settings). You can see the valid timezone on <a href="http://php.net/manual/en/timezones.php">http://php.net/manual/en/timezones.php</a> </p>
</blockquote>
<p><b>Methods</b></p>
...
<p><em>getScript ()</em> - <strong>v3.75</strong></p>
<blockquote>
  <p>Get the calendar output as script (for print/echo later). The method has the same purpose as <strong>writeScript()</strong> but return script as string instead of echo by itself.</p>
  <p>Ex. $myCalendar-&gt;getScript();</p>
</blockquote>
...
<p><em>setTheme (string theme_name)</em> -<strong> v3.75</strong></p>
<blockquote>
...
<p><em>setTimezone (string timezone)</em></p>
<blockquote>
  <p>Optional: Set timezone to calendar. The valid timezone string is as specified on <a href="http://php.net/manual/en/timezones.php">http://php.net/manual/en/timezones.php</a></p>
  <p>Ex $myCalendar-&gt;setTimezone(&quot;Europe/London&quot;);</p>
</blockquote>
...
<p><i>writeScript()</i></p>
<blockquote>
  <p>Write the output calendar to the screen. For buffer the output and return as string, use <strong>getScript()</strong></p>
</blockquote>
<br /><br /><br /><br />
